...
mixin _$BaseState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(EducationRemoteBaseModel error, VoidCallback callback) failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(EducationRemoteBaseModel error, VoidCallback callback)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$_FailureCopyWith<T, $Res> {
  ...
  $Res call({EducationRemoteBaseModel error, VoidCallback callback});
}
...
class _$_Failure<T> implements _Failure<T> {
  ...
  @override
  final EducationRemoteBaseModel error;
  @override
...
abstract class _Failure<T> implements UserModuleBaseState<T> {
  const factory _Failure(final EducationRemoteBaseModel error, final VoidCallback callback) =
      _$_Failure<T>;

  EducationRemoteBaseModel get error => throw _privateConstructorUsedError;
